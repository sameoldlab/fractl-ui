...
<style>
	.main {
		...
		& button:not(.address) {
			...
			font-weight: 600;
			font-size: 0.9em;
			border-radius: 16px; /* wrong radius */
	...
	/* button.address:hover::after {
		/* content: url('./Common/icons/copy.svg'); 
		position: absolute;
	} */
