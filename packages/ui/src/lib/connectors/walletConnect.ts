...
export function walletConnect(parameters: WalletConnectParameters) {
	...
	return createConnector<Provider, Properties, StorageItem>((config) => ({
		id: 'walletConnect',
		/** Base-64 encoded from https://github.com/WalletConnect/walletconnect-assets/blob/master/Icon/Blue%20(Default)/Icon.svg */
		...
		async connect({ chainId, ...rest } = { chainId: 1 }) {
			try {
