...
<footer class="links">
	<a href="https://github.com/sameoldlab/smooth-fractl">
		<svg height="20" aria-hidden="true" viewBox="0 0 16 16" fill="currentcolor" version="1.1" width="20" data-view-component="true">
	...
	<div>
		...
		<p>
			dapp UI Library for Svelte... <span class="whisper">
				(and eventually Web Components and Mitosis). Smooth what? fractal.
				Smooth fractal... it's a math thing apparently. Yes, I'm still working
				on the name.
			</span>
		</p>
	</div>
